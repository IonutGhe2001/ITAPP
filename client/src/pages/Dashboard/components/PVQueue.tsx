...
export function PvQueue({ items, isLoading, onGenerate }: PvQueueProps) {
      ...
      {isLoading ? (
        ...
        <ul className="space-y-3" aria-live="polite">
          {filteredItems.map((item) => {
            ...
            return (
              <li key={item.id} className="flex flex-col gap-3 rounded-lg border border-border bg-card/60 p-4 sm:flex-row sm:items-center sm:justify-between">
