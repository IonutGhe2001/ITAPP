  ...
  if (isError) {
    ...
    content = (
      <div className="flex h-full flex-col">
        ...
        <div className="sticky top-0 z-10 hidden border-b border-slate-200 bg-white px-4 py-3 text-[11px] font-semibold uppercase tracking-wide text-slate-500 sm:grid sm:grid-cols-11 sm:items-center">
